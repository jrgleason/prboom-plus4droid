...
./bootstrap --host=arm-linux
./configure CC=arm-linux-androideabi-gcc --prefix=/sdcard/doom --host=arm-linux --disable-gl --disable-nls CPPFLAGS="-I$ANDROID_ROOT/platforms/android-14/arch-arm/usr/include" 
